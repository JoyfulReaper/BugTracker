...
{
    public class BTNotificationService : IBTNotifcationService
    {
        ...
        public async Task<bool> SendEmailNotificationsAsync(Notification notification, string emailSubject)
        {
            ...
            if (btUser != null)
            {
                ...
                // Send our awesome amazing email
                try
                {
        ...
        public async Task SendEmailNotificationsByRoleAsync(Notification notification, int companyId, string role)
        {
            try
            {
                IEnumerable<BTUser> members = await _rolesService.GetUsersInRoleAsync(role, companyId);
        ...
        public async Task SendMembersEmailNotificationsAsync(Notification notification, IEnumerable<BTUser> members)
        {
            try
            {
                foreach (BTUser btUser in members)
